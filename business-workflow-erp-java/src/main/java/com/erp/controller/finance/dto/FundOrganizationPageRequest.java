...
@Data
@ApiModel("资金组织分页查询请求")
public class FundOrganizationPageRequest {

    @ApiModelProperty(value = "组织名称（模糊查询）", example = "主账户")
    ...
    @ApiModelProperty(value = "排序字段（支持：organizationCode, organizationName, createTime, updateTime）", example = "createTime")
